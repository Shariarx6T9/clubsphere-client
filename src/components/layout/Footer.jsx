      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Connecting communities and building lasting relationships through local clubs and events.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/clubs" className="text-gray-300 hover:text-white transition-colors">Browse Clubs</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 ClubSphere. All rights reserved. Built with ❤️ for connecting communities.
          </p>
        </div>
      </div>
    </footer>
