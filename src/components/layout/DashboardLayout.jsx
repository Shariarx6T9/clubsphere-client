...
const SidebarContent = ({ menuItems, onLinkClick, themeColor, dashboardTitle }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className={`flex items-center flex-shrink-0 px-4 h-16 bg-gradient-to-r ${currentTheme.gradient}`}>
...
const DashboardLayout = ({ children, menuItems, dashboardTitle, themeColor }) => {
        ...
        <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow-sm">
          ...
          <div className="flex-1 px-4 flex justify-between">
            ...
            <div className="ml-4 flex items-center md:ml-6">
              <span className={`hidden sm:inline-block text-sm font-medium ${currentTheme.text}`}>
                Welcome, {user?.name}
              </span>
            </div>
          </div>
